...
export const promptGenerated =
  /* GraphQL */ `subscription PromptGenerated($owner: String!) {
...
` as GeneratedSubscription<
  ...
  >;
export const promptUpdated =
  /* GraphQL */ `subscription PromptUpdated($owner: String!) {
...
` as GeneratedSubscription<
  ...
  >;
export const promptDeleted =
  /* GraphQL */ `subscription PromptDeleted($owner: String!) {
...
` as GeneratedSubscription<
  ...
  >;
export const taskGenerated =
  /* GraphQL */ `subscription TaskGenerated($owner: String!) {
...
export const taskUpdated =
  /* GraphQL */ `subscription TaskUpdated($owner: String!) {
...
export const taskDeleted =
  /* GraphQL */ `subscription TaskDeleted($owner: String!) {
